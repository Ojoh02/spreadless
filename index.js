        ...
        batchLabelsArrayTest = new Uint8Array(databaseSizeTest * NUM_CLASSES);
          let b = new Promise((resolve, reject) => {
            ...
            async function run() {
              ...
              const model = await tf.loadLayersModel('https://github.com/Ojoh02/spreadless/saved_models/model/model.json');
            ...
            async function run2() {
              ...
              for (let i = 0; i < PIXEL_TOTAL; i++) {
                ...
                largeModelArray[i] = await tf.loadLayersModel(`https://github.com/Ojoh02/spreadless/saved_models/model${i}/model.json`);
              }
